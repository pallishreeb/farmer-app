...
const adminrequestschemas = {
  ...
  //   taluka: Joi.string().min(2).max(50),
  ...
  //   firmName: Joi.string().min(3).max(100).required(),
  //   firmAddress: Joi.string().min(3).max(100).required(),
  //   phone: Joi.string().min(10).max(20).required(),
  //   landmark: Joi.string().min(2).max(200),
  //   city: Joi.string().min(2).max(50),
  //   state: Joi.string().min(2).max(50),
  //   pin: Joi.string().min(2).max(20),
  //   bankingdetail: Joi.object(),
